...
const HTML_PATH = path.join(ROOT, 'QuickAIBook_ad_2030.html');
const FRAMES_DIR = path.join(ROOT, '.render', 'frames2030');
const AUDIO_PATH = path.join(ROOT, '.render', 'audio2030.wav');

const FPS = 30;
const AD_DURATION_MS = 47000; // AD_CONFIG.totalDurationMs
